FIND_PATH(g2o_INCLUDE_DIR
        NAMES g2o/config.h
        HINTS /root/gamja_ws/devel/include)
...
if (g2o_INCLUDE_DIR)
    ...
    if (g2o_LIBRARY)
        ...
        set(g2o_LIBRARY /root/gamja_ws/devel/lib/libg2o.so)
        message("CMake Modules g2o LIB not found | bdc HARDCODING")
        message("CMake Modules g2o LIB:  ${g2o_LIBRARY}")
    endif ()
else ()
    message("CMake Modules g2o not found | bdc HARDCODING")
    set(g2o_INCLUDE_DIR /root/gamja_ws/devel/include/g2o)
    set(g2o_LIBRARY /root/gamja_ws/devel/lib/g2o/libg2o.so)
