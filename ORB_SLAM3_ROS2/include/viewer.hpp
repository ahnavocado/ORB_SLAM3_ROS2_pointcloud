...
#ifndef ORB_SLAM3_ROS2_VIEWER_H
#define ORB_SLAM3_ROS2_VIEWER_H
...
class viewer {
public:
    viewer(rclcpp::Node::SharedPtr node, ORB_SLAM3::LocalMapping *pLocalMapping, ORB_SLAM3::FrameDrawer *pFrameDrawer,
...
#endif//ORB_SLAM3_ROS_VIEWER_ROS2_H
